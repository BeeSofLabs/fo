...
import support.tools.component.FontManager;

import static com.labs.bee.app.fo.App.getContext;
...
public class MenuShopAdapter extends RecyclerView.Adapter<MenuShopAdapter.MenuViewHolder> {
    ...
    public void onBindViewHolder(MenuShopAdapter.MenuViewHolder holder, int position) {
        ...
        holder.menuRemoveButton.setTypeface(FontManager.getTypeface(getContext(), FontManager.FONTAWESOME));
